...
class GenerateOtpButton extends StatefulWidget {
  /// Width of the button.
  ///
  /// Default value: 60.0.
  final double? width;
  ...
  @override
  _GenerateOtpButtonState createState() => _GenerateOtpButtonState();
}

class _GenerateOtpButtonState extends State<GenerateOtpButton>
